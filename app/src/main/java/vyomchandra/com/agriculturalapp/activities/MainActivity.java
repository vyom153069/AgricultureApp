...
import vyomchandra.com.agriculturalapp.modals.MainListItem;
import vyomchandra.com.agriculturalapp.R;
import vyomchandra.com.agriculturalapp.adapters.MainAdapter;
...
public class MainActivity extends AppCompatActivity
    ...
    private String[] backgroundColors={"#EE19F023","#EE19F023","#EE19F023","#EE19F023","#EE19F023","#EE19F023"};
...
//        setSupportActionBar(toolbar);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.bazar_rates_nav) {
            ...
            String uriText = "mailto:" + Uri.encode("vyomchandra@gmail.com") + "?subject=" +
